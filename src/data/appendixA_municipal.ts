...
const a1Data: DocumentItem[] = [
  { id: 'A1-1', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '项目建议书批复文件及项目建议书', tableCode: '', standard: '发改部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-2', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '可行性研究报告批复文件及可行性研究报告', tableCode: '', standard: '发改部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-3', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '专家论证意见、项目评估文件', tableCode: '', standard: '发改部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-4', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '有关立项的会议纪要、领导批示等', tableCode: '', standard: '发改部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-5', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '选址意见书及附图', tableCode: '', standard: '规划部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-6', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '建设用地预审意见', tableCode: '', standard: '国土部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-7', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '建设用地批准文件', tableCode: '', standard: '国土部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-8', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '国有土地使用证', tableCode: '', standard: '国土部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-9', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '建设用地规划许可证及附图', tableCode: '', standard: '规划部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-10', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '地形测量和拨地测量成果报告', tableCode: '', standard: '规划部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-11', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '规划条件及附图', tableCode: '', standard: '规划部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-12', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '建设用地钉桩通知单', tableCode: '', standard: '规划部门', archiveUnits: { construction: true, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-13', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '环境影响评价报告及批复文件', tableCode: '', standard: '环保部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-14', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '水土保持方案及批复文件', tableCode: '', standard: '水务部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-15', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '防洪影响评价报告及批复', tableCode: '', standard: '水务部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-16', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '交通影响评价报告及批复', tableCode: '', standard: '交通部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-17', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '节能审查意见', tableCode: '', standard: '发改部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-18', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '文物调查、勘探保护文件', tableCode: '', standard: '文物部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-19', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '地下管线探测成果报告', tableCode: '', standard: '管线管理部门', archiveUnits: { construction: true, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-20', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '拆迁补偿安置文件', tableCode: '', standard: '住建部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: false } },
  { id: 'A1-21', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '建设工程规划许可证及附图', tableCode: '', standard: '规划部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
  { id: 'A1-22', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '临时建设工程规划许可证', tableCode: '', standard: '规划部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: false } },
  { id: 'A1-23', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '临时用地审批文件', tableCode: '', standard: '国土部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: false } },
  { id: 'A1-24', category: 'A类', subCategory: 'A1', subCategoryName: '立项用地规划许可文件', name: '地质灾害危险性评估报告', tableCode: '', standard: '国土部门', archiveUnits: { construction: false, supervision: false, constructionUnit: true, archive: true } },
];
...
const c5_2Data: DocumentItem[] = [
  ...
  { id: 'C5-2-16', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '焊接材料烘焙记录', tableCode: '施表C5-2-16', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
  { id: 'C5-2-17', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '钢结构安装施工记录', tableCode: '施表C5-2-17', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-18', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '高强度螺栓连接施工记录', tableCode: '施表C5-2-18', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-19', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '箱涵顶进记录', tableCode: '施表C5-2-19', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-20', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '基坑支护结构施工记录', tableCode: '施表C5-2-20', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-21', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '锚杆施工记录', tableCode: '施表C5-2-21', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-22', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '土钉墙施工记录', tableCode: '施表C5-2-22', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-23', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '沉井下沉施工记录', tableCode: '施表C5-2-23', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-24', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '沉井封底施工记录', tableCode: '施表C5-2-24', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-25', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '模板安装检查记录', tableCode: '施表C5-2-25', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
  { id: 'C5-2-26', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '模板拆除申请及验收记录', tableCode: '施表C5-2-26', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
  { id: 'C5-2-27', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '构件吊装施工记录', tableCode: '施表C5-2-27', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-28', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '后浇带施工记录', tableCode: '施表C5-2-28', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-2-29', category: 'C类', subCategory: 'C5-2', subCategoryName: '基础/主体结构工程通用施工记录', name: '其他基础/主体结构工程施工记录', tableCode: '施表C5-2-29', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
];

const c5_3Data: DocumentItem[] = [
  { id: 'C5-3-1', category: 'C类', subCategory: 'C5-3', subCategoryName: '道路、桥梁工程施工记录', name: '路基压实度检测报告汇总表', tableCode: '施表C5-3-1', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-3-2', category: 'C类', subCategory: 'C5-3', subCategoryName: '道路、桥梁工程施工记录', name: '路面结构层施工记录', tableCode: '施表C5-3-2', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-3-3', category: 'C类', subCategory: 'C5-3', subCategoryName: '道路、桥梁工程施工记录', name: '沥青混合料摊铺记录', tableCode: '施表C5-3-3', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-3-4', category: 'C类', subCategory: 'C5-3', subCategoryName: '道路、桥梁工程施工记录', name: '桥梁上部结构施工记录', tableCode: '施表C5-3-4', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-3-5', category: 'C类', subCategory: 'C5-3', subCategoryName: '道路、桥梁工程施工记录', name: '桥梁下部结构施工记录', tableCode: '施表C5-3-5', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-3-6', category: 'C类', subCategory: 'C5-3', subCategoryName: '道路、桥梁工程施工记录', name: '其他道路、桥梁工程施工记录', tableCode: '施表C5-3-6', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
];

const c5_4Data: DocumentItem[] = [
  { id: 'C5-4-1', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道沟槽开挖施工记录', tableCode: '施表C5-4-1', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-2', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道基础施工记录', tableCode: '施表C5-4-2', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-3', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道安装施工记录', tableCode: '施表C5-4-3', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-4', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道接口处理记录', tableCode: '施表C5-4-4', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-5', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道回填施工记录', tableCode: '施表C5-4-5', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-6', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道严密性试验记录', tableCode: '施表C5-4-6', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-7', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道冲洗消毒记录', tableCode: '施表C5-4-7', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-8', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道CCTV检测记录', tableCode: '施表C5-4-8', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-9', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '顶管施工记录', tableCode: '施表C5-4-9', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-10', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '盾构隧道掘进施工记录', tableCode: '施表C5-4-10', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-11', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '盾构隧道管片拼装记录', tableCode: '施表C5-4-11', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-12', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '盾构隧道注浆记录', tableCode: '施表C5-4-12', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-13', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '浅埋暗挖隧道施工记录', tableCode: '施表C5-4-13', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-14', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '隧道初期支护施工记录', tableCode: '施表C5-4-14', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-15', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '隧道二次衬砌施工记录', tableCode: '施表C5-4-15', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-16', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '检查井施工记录', tableCode: '施表C5-4-16', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-17', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道焊接施工记录', tableCode: '施表C5-4-17', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-18', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道防腐层施工记录', tableCode: '施表C5-4-18', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-19', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道保温层施工记录', tableCode: '施表C5-4-19', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-20', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '管道穿越施工记录', tableCode: '施表C5-4-20', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-4-21', category: 'C类', subCategory: 'C5-4', subCategoryName: '管(隧)道工程施工记录', name: '其他管(隧)道工程施工记录', tableCode: '施表C5-4-21', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
];


const c5_5Data: DocumentItem[] = [
  { id: 'C5-5-1', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '设备基础交接验收记录', tableCode: '施表C5-5-1', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-2', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '设备开箱检验记录', tableCode: '施表C5-5-2', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
  { id: 'C5-5-3', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '设备安装记录', tableCode: '施表C5-5-3', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-4', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '设备单机试运转记录', tableCode: '施表C5-5-4', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-5', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '设备联动试运转记录', tableCode: '施表C5-5-5', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-6', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '水池满水试验记录', tableCode: '施表C5-5-6', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-7', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '污泥消化池气密性试验记录', tableCode: '施表C5-5-7', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-8', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '管道吹扫/清洗记录', tableCode: '施表C5-5-8', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-9', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '管道压力试验记录', tableCode: '施表C5-5-9', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-10', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '管道/设备防腐施工记录', tableCode: '施表C5-5-10', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-11', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '管道/设备绝热施工记录', tableCode: '施表C5-5-11', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-12', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '仪表校准记录', tableCode: '施表C5-5-12', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-13', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '自动化控制系统调试记录', tableCode: '施表C5-5-13', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-14', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '起重设备安装记录', tableCode: '施表C5-5-14', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-15', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '水泵安装记录', tableCode: '施表C5-5-15', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-16', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '风机安装记录', tableCode: '施表C5-5-16', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-17', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '格栅安装记录', tableCode: '施表C5-5-17', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-18', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '刮泥机安装记录', tableCode: '施表C5-5-18', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-5-19', category: 'C类', subCategory: 'C5-5', subCategoryName: '厂(场)、站设备安装工程施工记录', name: '其他厂(场)/站设备安装工程施工记录', tableCode: '施表C5-5-19', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
];

const c5_6Data: DocumentItem[] = [
  { id: 'C5-6-1', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '电气设备交接试验记录', tableCode: '施表C5-6-1', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-2', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '电缆敷设记录', tableCode: '施表C5-6-2', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-3', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '电缆接头制作记录', tableCode: '施表C5-6-3', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-4', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '电气照明通电试运行记录', tableCode: '施表C5-6-4', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-5', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '电气设备空载试运行记录', tableCode: '施表C5-6-5', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-6', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '接地电阻测试记录', tableCode: '施表C5-6-6', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-7', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '绝缘电阻测试记录', tableCode: '施表C5-6-7', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-8', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '漏电保护装置检测记录', tableCode: '施表C5-6-8', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-9', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '防雷接地装置检测记录', tableCode: '施表C5-6-9', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-10', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '变压器安装记录', tableCode: '施表C5-6-10', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-11', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '高低压开关柜安装记录', tableCode: '施表C5-6-11', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-12', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '母线安装记录', tableCode: '施表C5-6-12', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C5-6-13', category: 'C类', subCategory: 'C5-6', subCategoryName: '电气安装工程施工记录', name: '其他电气安装工程施工记录', tableCode: '施表C5-6-13', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
];

// C6
const c6_1Data: DocumentItem[] = [
  { id: 'C6-1-1', category: 'C类', subCategory: 'C6-1', subCategoryName: '施工试验检测报告(通用)', name: '施工试验检测计划', tableCode: '施表C6-1-1', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
];

const c6_2Data: DocumentItem[] = [
  { id: 'C6-2-1', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '土工击实试验报告', tableCode: '施表C6-2-1', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-2', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '土工压实度试验报告', tableCode: '施表C6-2-2', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-3', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '地基承载力试验报告', tableCode: '施表C6-2-3', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-4', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '桩基检测报告', tableCode: '施表C6-2-4', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-5', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '钢筋连接试验报告', tableCode: '施表C6-2-5', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-6', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '钢筋机械连接工艺检验报告', tableCode: '施表C6-2-6', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-7', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '钢筋焊接工艺试验报告', tableCode: '施表C6-2-7', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-8', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '混凝土配合比设计报告', tableCode: '施表C6-2-8', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-9', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '混凝土试块强度试验报告', tableCode: '施表C6-2-9', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-10', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '混凝土强度统计评定表', tableCode: '施表C6-2-10', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-11', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '混凝土抗渗试验报告', tableCode: '施表C6-2-11', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-12', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '混凝土抗冻试验报告', tableCode: '施表C6-2-12', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-13', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '砂浆配合比设计报告', tableCode: '施表C6-2-13', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-14', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '砂浆试块强度试验报告', tableCode: '施表C6-2-14', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-15', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '焊缝无损检测报告', tableCode: '施表C6-2-15', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-16', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '高强度螺栓连接摩擦面抗滑移系数试验报告', tableCode: '施表C6-2-16', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-17', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '钢结构防腐涂料检测报告', tableCode: '施表C6-2-17', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-18', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '钢结构防火涂料检测报告', tableCode: '施表C6-2-18', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-19', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '结构实体钢筋保护层厚度检测报告', tableCode: '施表C6-2-19', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-20', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '结构实体混凝土强度检测报告', tableCode: '施表C6-2-20', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-21', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '后置埋件抗拔强度检测报告', tableCode: '施表C6-2-21', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-22', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '回弹法检测混凝土强度报告', tableCode: '施表C6-2-22', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-23', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '钻芯法检测混凝土强度报告', tableCode: '施表C6-2-23', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-24', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '锚杆抗拔承载力检测报告', tableCode: '施表C6-2-24', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: true } },
  { id: 'C6-2-25', category: 'C类', subCategory: 'C6-2', subCategoryName: '基础/主体结构工程', name: '其他基础/主体结构工程试验检测报告', tableCode: '施表C6-2-25', standard: 'DB11/T 808', archiveUnits: { construction: true, supervision: true, constructionUnit: true, archive: false } },
];
...
// 导出汇总
// ============================================================
export const appendixAData_municipal: DocumentItem[] = [
  ...a1Data,
  ...a2Data,
  ...a3Data,
  ...a4Data,
...
export default appendixAData_municipal;
