...
router.post('/issue/report', requireAuth, (req, res) => {
  ...
  const db = getDb(); db.exec('CREATE TABLE IF NOT EXISTS mobile_issues (id INTEGER PRIMARY KEY AUTOINCREMENT, project_id INTEGER NOT NULL REFERENCES projects(id) ON DELETE CASCADE, title TEXT NOT NULL, description TEXT DEFAULT \'\', severity TEXT DEFAULT \'normal\', status TEXT DEFAULT \'reported\', assignee TEXT DEFAULT \'\', photo_path TEXT DEFAULT \'\', reported_by TEXT NOT NULL, created_at TEXT DEFAULT (datetime(\'now\')), updated_at TEXT DEFAULT (datetime(\'now\')));');
...
router.post('/progress/report', requireAuth, (req, res) => {
  ...
  const db = getDb(); db.exec('CREATE TABLE IF NOT EXISTS mobile_progress (id INTEGER PRIMARY KEY AUTOINCREMENT, project_id INTEGER NOT NULL, plan_item_id TEXT NULL, title TEXT NOT NULL, percentage REAL DEFAULT 0, note TEXT DEFAULT \'\', reported_by TEXT NOT NULL, match_status TEXT DEFAULT \'unmatched\', created_at TEXT DEFAULT (datetime(\'now\')));');
...
// ===== 12. 项目日报系统 =====
function ensureDailyTables(db) {
  db.exec("CREATE TABLE IF NOT EXISTS daily_reports (id INTEGER PRIMARY KEY AUTOINCREMENT, project_id INTEGER NOT NULL REFERENCES projects(id) ON DELETE CASCADE, report_date TEXT NOT NULL, weather_day TEXT DEFAULT '', weather_night TEXT DEFAULT '', weather_alert TEXT DEFAULT '', weather_alert_level TEXT DEFAULT '', managers_main INTEGER DEFAULT 0, managers_labor INTEGER DEFAULT 0, managers_specialty INTEGER DEFAULT 0, workers_main INTEGER DEFAULT 0, workers_labor INTEGER DEFAULT 0, workers_specialty INTEGER DEFAULT 0, workers_special INTEGER DEFAULT 0, workers_total INTEGER DEFAULT 0, machinery TEXT DEFAULT '[]', machinery_total INTEGER DEFAULT 0, materials TEXT DEFAULT '[]', tasks TEXT DEFAULT '[]', quality_risks TEXT DEFAULT '[]', issues TEXT DEFAULT '[]', photos TEXT DEFAULT '[]', original_text TEXT DEFAULT '', notes TEXT DEFAULT '', reported_by TEXT NOT NULL, deleted INTEGER DEFAULT 0, created_at TEXT DEFAULT (datetime('now')), UNIQUE(project_id, report_date)); CREATE TABLE IF NOT EXISTS daily_workers (id INTEGER PRIMARY KEY AUTOINCREMENT, daily_id INTEGER NOT NULL REFERENCES daily_reports(id) ON DELETE CASCADE, report_date TEXT NOT NULL, worker_type TEXT NOT NULL, count INTEGER DEFAULT 0); CREATE TABLE IF NOT EXISTS daily_machinery (id INTEGER PRIMARY KEY AUTOINCREMENT, daily_id INTEGER NOT NULL REFERENCES daily_reports(id) ON DELETE CASCADE, report_date TEXT NOT NULL, name TEXT NOT NULL, spec TEXT DEFAULT '', count INTEGER DEFAULT 0); CREATE TABLE IF NOT EXISTS daily_progress (id INTEGER PRIMARY KEY AUTOINCREMENT, daily_id INTEGER NOT NULL REFERENCES daily_reports(id) ON DELETE CASCADE, report_date TEXT NOT NULL, area TEXT DEFAULT '', description TEXT NOT NULL, workers INTEGER DEFAULT 0, today_pct TEXT DEFAULT '', total_pct TEXT DEFAULT '', schedule_deviation TEXT DEFAULT '', contractor TEXT DEFAULT ''); CREATE TABLE IF NOT EXISTS daily_risks (id INTEGER PRIMARY KEY AUTOINCREMENT, daily_id INTEGER NOT NULL REFERENCES daily_reports(id) ON DELETE CASCADE, report_date TEXT NOT NULL, category TEXT NOT NULL, name TEXT DEFAULT '', detail TEXT DEFAULT '', status TEXT DEFAULT '', impact_days INTEGER DEFAULT 0);");
